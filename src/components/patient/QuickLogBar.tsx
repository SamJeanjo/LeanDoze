...
export function QuickLogBar() {
  ...
  return (
    <>
      <section id="quick-log" className="rounded-[28px] border border-slate-200/70 bg-white p-6 shadow-[0_24px_70px_rgba(15,23,42,0.06)]">
        ...
        <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {actions.map((action) => (
            <button
              ...
              className="flex min-h-24 flex-col items-center justify-center gap-2 rounded-2xl bg-[#F8FAFC] px-3 text-sm font-semibold text-slate-600 ring-1 ring-[#E2E8F0]/80 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-white hover:text-[#0F766E] hover:shadow-[0_28px_80px_rgba(15,23,42,0.09)]"
            >
