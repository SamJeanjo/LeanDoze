  ...
  return (
    <article className="group relative z-0 rounded-[28px] border border-slate-200/70 bg-white p-4 shadow-[0_24px_70px_rgba(15,23,42,0.06)] transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_28px_80px_rgba(15,23,42,0.09)]">
      ...
      <button
        ...
        className={done ? "mt-4 min-h-11 rounded-full bg-[#F0FDF4] px-5 py-2.5 text-sm font-semibold text-[#15803D] ring-1 ring-[#BBF7D0]" : "mt-4 min-h-11 rounded-full bg-[#07111F] px-5 py-2.5 text-sm font-semibold text-white transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0"}
      >
        {done ? "Completed" : cta}
      </button>
    </article>
