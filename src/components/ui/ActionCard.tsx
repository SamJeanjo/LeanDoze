...
export function ActionCard({ title, reason, cta, progress, icon: Icon, complete = false }: ActionCardProps) {
  ...
  return (
    <article className="group relative z-0 rounded-3xl border border-slate-200/70 bg-white p-4 shadow-[0_20px_60px_rgba(15,23,42,0.06)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(15,23,42,0.09)]">
